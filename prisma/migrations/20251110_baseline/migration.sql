...
CREATE TABLE "shop_reports" (
    ...
    "etsyFeeRate" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "etsyFeesRetainedOnRefunds" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "etsyProcessingFees" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "etsyTransactionFees" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "grossRevenue" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "netRevenueAfterRefunds" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "takeHomeRate" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalEtsyFees" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalShippingCharged" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "actualShippingCost" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "dutyAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "fedexProcessingFee" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "shippingProfit" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "taxAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalCostWithShipping" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "ad_spend_rate" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "roas" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "total_ad_spend" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "idx_orders_timestamp_status" ON "orders"("created_timestamp", "status");
...
-- CreateIndex
CREATE INDEX "idx_order_transactions_order_listing" ON "order_transactions"("order_id", "listing_id");
...
-- CreateIndex
CREATE INDEX "idx_order_transactions_sku" ON "order_transactions"("sku");

-- CreateIndex
CREATE INDEX "idx_order_shipments_order_id" ON "order_shipments"("order_id");

-- CreateIndex
CREATE INDEX "idx_order_shipments_shipped_timestamp" ON "order_shipments"("shipped_timestamp");

-- CreateIndex
CREATE INDEX "idx_order_refunds_created_timestamp" ON "order_refunds"("created_timestamp");
...
-- CreateIndex
CREATE INDEX "idx_ledger_entries_created_timestamp" ON "ledger_entries"("created_timestamp");
...
-- CreateIndex
CREATE INDEX "idx_reviews_created_timestamp" ON "reviews"("created_timestamp");
...
-- CreateIndex
CREATE INDEX "idx_listing_products_is_deleted" ON "listing_products"("is_deleted");

-- CreateIndex
CREATE INDEX "idx_listing_products_listing_id" ON "listing_products"("listing_id");

-- CreateIndex
CREATE INDEX "idx_listing_products_sku" ON "listing_products"("sku");

-- CreateIndex
CREATE INDEX "idx_listing_products_sku_active" ON "listing_products"("sku", "is_deleted");

-- CreateIndex
CREATE UNIQUE INDEX "listing_products_listing_id_product_id_key" ON "listing_products"("listing_id", "product_id");

-- CreateIndex
CREATE INDEX "idx_product_offerings_enabled_not_deleted" ON "product_offerings"("is_enabled", "is_deleted");

-- CreateIndex
CREATE INDEX "idx_product_offerings_listing_product_id" ON "product_offerings"("listing_product_id");
...
-- CreateIndex
CREATE INDEX "idx_shop_reports_dates" ON "shop_reports"("periodStart", "periodEnd");

-- CreateIndex
CREATE UNIQUE INDEX "shop_reports_periodType_periodStart_periodEnd_key" ON "shop_reports"("periodType", "periodStart", "periodEnd");

-- CreateIndex
CREATE INDEX "idx_listing_reports_listing_dates" ON "listing_reports"("listingId", "periodStart", "periodEnd");

-- CreateIndex
CREATE INDEX "idx_listing_reports_listing_id" ON "listing_reports"("listingId");
...
-- CreateIndex
CREATE INDEX "idx_product_reports_sku" ON "product_reports"("sku");

-- CreateIndex
CREATE INDEX "idx_product_reports_sku_dates" ON "product_reports"("sku", "periodStart", "periodEnd");
...
-- CreateIndex
CREATE INDEX "idx_listing_ad_stats_listing_id" ON "listing_ad_stats"("listing_id");

-- CreateIndex
CREATE INDEX "idx_listing_ad_stats_listing_period" ON "listing_ad_stats"("listing_id", "period_start", "period_end");

-- CreateIndex
CREATE INDEX "idx_listing_ad_stats_period_end" ON "listing_ad_stats"("period_end");

-- CreateIndex
CREATE INDEX "idx_listing_ad_stats_period_start" ON "listing_ad_stats"("period_start");
...
-- CreateIndex
CREATE INDEX "idx_listing_visit_stats_listing_id" ON "listing_visit_stats"("listing_id");

-- CreateIndex
CREATE INDEX "idx_listing_visit_stats_listing_period" ON "listing_visit_stats"("listing_id", "period_start", "period_end");

-- CreateIndex
CREATE INDEX "idx_listing_visit_stats_period_end" ON "listing_visit_stats"("period_end");

-- CreateIndex
CREATE INDEX "idx_listing_visit_stats_period_start" ON "listing_visit_stats"("period_start");
